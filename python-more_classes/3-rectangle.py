...
for width and height, and methods to calculate area and perimeter as well as
and a `__str__` method to print the rectangle using `#`"""
...
class Rectangle:
    ...
    def __str__(self):
        """Returns a string presentation of the rectangle using `#` character."""
        if self.__width == 0 or self.__height == 0:
            return ("")
